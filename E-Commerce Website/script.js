document.addEventListener('DOMContentLoaded', function () {
    ...
    const cart = [];
    const products = [
        { id: 1, name: "T-Shirt", price: 299.00, image: "Images/T-Shirt.png", category: "clothing", reviews: [] },
        { id: 2, name: "Shirt", price: 899.00, image: "Images/Shirt.png", category: "clothing", reviews: [] },
        { id: 3, name: "Pant", price: 399.00, image: "Images/Pant.png", category: "clothing", reviews: [] },
        { id: 4, name: "Lace Baby Girl Dress", price: 2999.00, image: "Images/Baby-Dress.png", category: "clothing", reviews: [] },
        ...
        { id: 8, name: "Baby Girl Frock", price: 1149.00, image: "Images/Baby-Frock.jpg", category: "clothing", reviews: [] },
        { id: 9, name: "Remote Control Monster Truck (Rechargeable)", price: 699.00, image: "Images/Truck.jpg", category: "toys", reviews: [] },
        ...
        products.forEach(product => {
            ...
            productElement.innerHTML = `
                ...
                <div class="buttons">
                    ...
                    <button class="view-reviews-videos">View Reviews</button>
    ...
    function viewReviewsAndVideos(product) {
        ...
        const videoUrl = prompt("Enter the name of the product:");
        if (videoUrl) {
